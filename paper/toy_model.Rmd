...
detnut_params <- readRDS(here("analysis/data/derived_data/DetNut_litter_fits.rds"))|>
...
ggplot()+
  ...
  ggsave(leaching.p, filename = "leaching_simulation.jpeg", path = here("analysis/paper/figures"),
...
simcurves.p
  ggsave(simcurves.p, filename = "simulated_decomp_curves.jpeg", path = here("analysis/paper/figures"),
       height = 6, width = 9, units = "in")
```
...
if(file.exists(here("analysis/data/derived_data/toymodel_fits.rds"))){
  
  sim_output_fits <- readRDS(here("analysis/data/derived_data/toymodel_fits.rds"))
...
saveRDS(sim_output_fits, file = here("analysis/data/derived_data/toymodel_fits.rds")) 
}
...
ggsave(logdiff_grid, filename = "k_logdiff_sims.jpeg", path = here("analysis/paper/figures"),
...
ggsave(diff_grid, filename = "Fig4_diff_sims.jpeg", path = here("analysis/paper/figures"),
       height = 9, width = 12, units = "in")
