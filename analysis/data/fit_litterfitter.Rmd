...
litter_df <- read_csv(here("analysis/data/derived_data/tidied_detrital_nutrients_data.csv"))
```
...
if(file.exists(here("analysis/data/derived_data/DetNut_litter_fits.rds"))){
...
# save to file
saveRDS(litter_fits, file = here("analysis/data/derived_data/DetNut_litter_fits.rds")) 
