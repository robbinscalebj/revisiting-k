...
litter_fits <- readRDS(here("analysis/data/derived_data/DetNut_litter_fits.rds")) # model fits of time series from litterfitter
weibull_sigs <- read_csv(here("analysis/data/derived_data/DetNut_weibullalpha_bootstraps.csv"))

source(here("analysis/paper/litterfitter_prediction_functions.R"))
...
##delete me
blah <- tidy_fits|>filter(terminal_mass_prop < 0.2)|>
  select(cohort_id, weibull_alpha, Mass_per_remaining, series_length)
...
lagged.p <- ggplot()+
  ...
  geom_point(data = obs_120, aes(x = Meas_Day, y = mass_prop), 
             size = 4, fill = "grey", color = "black", shape = 21)+
  scale_y_continuous(limits = c(0, max(obs_120$mass_prop)+0.1), breaks = c(0,0.25,0.5,0.75,1.0))+
...
ggsave(examples.p2, filename = "Fig1_example_plots.jpeg", path = here("analysis/paper/figures"),
...
ggsave(fit_counts.p, filename = "modfit_comparisons.jpeg", path = here("analysis/paper/figures"),
...
ggsave(fit_counts2.p, filename = "Fig_Sx_modfit_comparisons_by_serieslength.jpeg", path = here("analysis/paper/figures"),
...
ggsave(rmse_by_sl.p, filename = "rmse_by_serieslength.jpeg", path = here("analysis/paper/figures"),
...
sl_aic_brm <- brm(negexp_best ~ series_length, family = bernoulli(link = "logit"),
               ...
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/sl_aic_brm"))

sl_aic_brm1 <- brm(negexp_best ~ log(series_length), family = bernoulli(link = "logit"),
               data = mod_gof_bin|>filter(gof_metric == "AICc"), 
               chains = 4 , iter = 4000, warmup = 500, 
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/sl_aic_brm1"))
...
sl_bic_brm <- brm(negexp_best ~ series_length, family = bernoulli(link = "logit"),
               ...
               chains = 4 , iter = 4000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/sl_bic_brm"))

sl_bic_brm1 <- brm(negexp_best ~ log(series_length), family = bernoulli(link = "logit"),
               data = mod_gof_bin|>filter(gof_metric == "BIC"), 
               chains = 4 , iter = 4000, warmup = 500, cores = 4,
               file = here("analysis/data/derived_data/regression_fits/sl_bic_brm1"))
...
termmass_aic_brm <- brm(negexp_best ~ terminal_mass_prop, family = bernoulli(link = "logit"),
               ...
               chains = 4 , iter = 4000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/termmass_aic_brm"))
...
termmass_aic_brm1 <- brm(negexp_best ~ log(terminal_mass_prop), family = bernoulli(link = "logit"),
               ...
               chains = 4 , iter = 4000, warmup = 500, 
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/termmass_aic_brm1"))
...
termmass_bic_brm <- brm(negexp_best ~ terminal_mass_prop, family = bernoulli(link = "logit"),
               ...
               chains = 4 , iter = 4000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/termmass_bic_brm"))

termmass_bic_brm1 <- brm(negexp_best ~ log(terminal_mass_prop), family = bernoulli(link = "logit"),
               data = mod_gof_bin|>filter(gof_metric == "BIC"), 
               chains = 4 , iter = 4000, warmup = 500, cores = 4,
               file = here("analysis/data/derived_data/regression_fits/termmass_bic_brm1"))
...
ggsave(comperrors.p, filename = "Fig2_modfit_comperrors.jpeg", path = here("analysis/paper/figures"),
...
alpha_distro.p<-ggplot(alpha_df|>filter(weibull_alpha <20))+
  ...
  theme(axis.title = element_text(face = "bold", size = 16), axis.text = element_text(size = 14, color = "black"),
        legend.title = element_text(size = 14), legend.text = element_text(size = 12))
alpha_distro.p
ggsave(alpha_distro.p, filename = "weibull_alpha_histogram.jpeg", path = here("analysis/paper/figures"),
       height = 6, width = 6, units = "in")
```
...
bind_rows(alpha_corrs, alphadev_corrs)|>
  ...
  write_csv(here("analysis/paper/weibull_pearson_correlation_summaries.csv"))
...
ggsave(alpha_covars.p, filename = "FigSx_weibull_alpha_covar-corr.jpeg", path = here("analysis/paper/figures"),
       height = 6, width = 10, units = "in")
...
mesh_weibull_brm <- brm(weibull_alpha ~ mesh_cat, family = Gamma(),
               ...
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/mesh_weibull_brm"))
...
mesh_weibull_brm2 <- brm(bf(weibull_alpha ~ mesh_cat, 
               ...
               chains = 4 , iter = 2000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/mesh_weibull_brm2"))
...
mesh_weibull_brm3 <- brm(bf(weibull_alpha ~ mesh_cat, 
               ...
               chains = 4 , iter = 2000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/mesh_weibull_brm3"))
...
ggsave(mesh_weibull.p, filename = "FigSx_mesh_weibull.jpeg", path = here("analysis/paper/figures"),
...
weibullsig_sl_brm <- brm(weibulla_overlap_1 ~ series_length, family = bernoulli(link = "logit"),
               ...
               chains = 4 , iter = 2000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/weibullsig_sl_brm"))

weibullsig_sl_brm2 <- brm(weibulla_overlap_1 ~ log(series_length), family = bernoulli(link = "logit"),
               data = tidy_fits, 
               chains = 4 , iter = 2000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/weibullsig_sl_brm2"))
...
weibullsig_termmass_brm <- brm(weibulla_overlap_1 ~ terminal_mass_prop, family = bernoulli(link = "logit"),
               ...
               chains = 4 , iter = 2000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/weibullsig_termmass_brm"))

weibullsig_termmass_brm2 <- brm(weibulla_overlap_1 ~ log(terminal_mass_prop), family = bernoulli(link = "logit"),
               data = tidy_fits, 
               chains = 4 , iter = 2000, warmup = 500,
               cores = 4,
               file = here("analysis/data/derived_data/regression_fits/weibullsig_termmass_brm2"))
...
k_termmass_brm1 <- brm(bf(negexp_k ~ terminal_mass_prop,
                      ...
                      data = tidy_fits, 
                      chains = 4, iter = 2000, warmup = 500,
                      file = here("analysis/data/derived_data/regression_fits/k_termmass_brm"))

k_termmass_brm2 <- brm(bf(negexp_k ~ terminal_mass_prop+weibull_alpha),
                      family=lognormal(),
                      data = tidy_fits|>filter(weibull_alpha <20), 
                      chains = 4, iter = 2000, warmup = 500,
                      file = here("analysis/data/derived_data/regression_fits/k_termmass_brm2"))
...
ggsave(k_termmass.p, filename = "FigSx_k_termmass_alpha.jpeg", path = here("analysis/paper/figures"),
...
ggsave(alphas.p, filename = "Fig3_weibull_alpha_sigcorrs.jpeg", path = here("analysis/paper/figures"),
       height = 12, width = 8, units = "in")


```
# Instantaneous slopes with Weibull fitted model

```{r}
#trim each cohort's predictions to the last available date - i.e., don't extrapolate beyond data range
#only pull slopes from available data points to reflect data availability
kapp_df <- litter_df|>select(cohort_id, Meas_Day, Mass_prop)|>
  mutate(observed = "observed")|> # mark where we actually had data
  group_by(cohort_id)|>
  complete(Meas_Day = full_seq(Meas_Day, 1))|>
  left_join(newpreds_df|>filter(model == "weibull"))|>left_join(tidy_fits|>select(weibull_alpha,cohort_id))|>
  group_by(cohort_id)|>
  mutate(dt = Meas_Day - lag(Meas_Day),
         logM = log(.pred),
         dlogM = logM - lag(logM),
         k_app = -dlogM/dt,
         kdd_app = (lead(logM)-2*logM+lag(logM))/(lead(logM)-logM)^2)|>
  ungroup()|>
  filter(observed == "observed", Meas_Day != 0)

kapp_df2<-kapp_df|>group_by(cohort_id)|>filter(last(Mass_prop)<0.25, weibull_alpha>1)
  

ggplot(kapp_df2, aes(x = Meas_Day, y = .pred, group= cohort_id))+
  geom_line()+scale_y_continuous(trans = "log", limits = c(0.05, 1))

ggplot(kapp_df, aes(x = Mass_prop, y = k_app))+
  geom_point()+
  scale_x_continuous(trans = "reverse", limits = c(1,0))+
  scale_y_continuous(limits = c(-0.001,0.1))+
  xlab("Mass remaining")+
  geom_smooth(method = "gam")+
  theme_bw()

ggplot(kapp_df|>filter(k_app<0.1), aes(x = k_app))+
  geom_histogram()

ggplot(kapp_df, aes(x = Mass_prop, y = kdd_app))+
  geom_point()+
...
```{r}
m0 <-  mgcv::gam(data = kapp_df, k_app~ s(Mass_prop))
m0 <-  mgcv::gam(data = kapp_df, k_app~ s(Mass_prop))
m1 <- mgcv::gamm(data = kapp_df, k_app~ s(Mass_prop)+s(Mass_prop, by = as_factor(cohort_id), bs = "fs", k = 3))

plot_predictions(m0, by = "Mass_prop", points = 0.5)+
  scale_x_continuous(trans = "reverse", limits = c(1,0))+
